...
2. Write `$DOMAINS_DIR/<domain>/specs/suggested_rulesets/<ruleset_name>.yaml` using exactly this schema:

```yaml
# Auto-generated by /suggest-ruleset-io — do not edit manually
# Domain: <domain>
...
3. Confirm each file written:
   ```
   Saved: $DOMAINS_DIR/<domain>/specs/suggested_rulesets/<ruleset_name>.yaml
   ```
...
```
$DOMAINS_DIR/<domain>/specs/suggested_rulesets/<ruleset_name>.yaml    [CREATED]
```
